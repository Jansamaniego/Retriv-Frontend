...
const CreateProductStepTracker: React.FC<IOrderTrackerProps> = ({
  formStep,
}) => {
  return (
    <PlacedOrderTrackerFlexWrapper>
      <TrackerFlexWrapper>
        ...
        <TrackerLine active={formStep !== 0 && formStep !== 1} />
        <TrackerLine active={formStep === 3} />
        <TrackerPoint active={formStep === 3}>4</TrackerPoint>
      </TrackerFlexWrapper>
    </PlacedOrderTrackerFlexWrapper>
  );
};

export default CreateProductStepTracker;
